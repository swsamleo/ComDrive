...
from flow.controllers.car_following_models import IDMController_predict_margin_with_noise,IDMController_with_noise
...
sensor_system.add_new_sensor("distance", "G", error_type="Gaussian", error_size=1)
