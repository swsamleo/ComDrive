...
from flow.controllers.car_following_models import IDMController_predict_margin_with_noise,\
    ...
    BandoController_predict_margin_with_noise, IDMController_platooning_predict_margin,\
    IDMController_with_noise_platooning
...
vehicles.add("testing_car_IDM_1",
             acceleration_controller=(IDMController_with_noise_platooning, {"fail_safe": 'instantaneous'}),
             routing_controller=(ContinuousRouter, {}),
             num_vehicles=5,
             car_following_params=sumo_car_following_para1,
             sensor_system=sensor_system,
...
vehicles.add("testing_car_IDM_4",
             acceleration_controller=(IDMController_with_noise_platooning, {"fail_safe": 'instantaneous'}),
             routing_controller=(ContinuousRouter, {}),
             num_vehicles=5,
             car_following_params=sumo_car_following_para1,
...
vehicles.add("testing_car_IDM_5",
             acceleration_controller=(IDMController_with_noise_platooning, {"fail_safe": 'instantaneous'}),
             routing_controller=(ContinuousRouter, {}),
             num_vehicles=5,
             car_following_params=sumo_car_following_para1,
...
from flow.core.platooning_experiement import Experiment
