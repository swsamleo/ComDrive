...
class Margin_DQN_withbackway_Env(Env):
    ...
    def calculate_reward(self):
        ...
        #
        # self.cur_traffic_throughput_with_noise = self.perception_system.get_traffic_throughput_with_noise(veh_ids)
        cost_traffic_throughput = (self.cur_fairness_metric-self.max_fairness_metric)/(self.max_fairness_metric+k)
        cost_fairness_metric = (self.cur_traffic_throughput-self.max_traffic_throughput)/(self.max_traffic_throughput+k)
