...
sensor_system.add_new_sensor(sensor_type="distance", sensor_name="G", error_type="Gaussian_3", error_size=1)
...
from flow.core.sensor_error_experiement import Experiment
